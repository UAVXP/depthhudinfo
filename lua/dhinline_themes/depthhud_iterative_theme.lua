...
function THEME:Load()
	...
	surface.CreateFont( "dhfont_num3", {
		font = "halflife2",
		size = 36,
		weight = 0,
		antialias = false,
	...
	surface.CreateFont( "dhfont_num2", {
		font = "halflife2",
		size = 26,
		weight = 2,
		antialias = false,
	...
	surface.CreateFont( "dhfont_num1", {
		font = "halflife2",
		size = 26,
		weight = 2,
		antialias = false,
	...
	surface.CreateFont( "dhfont_num0", {
		font = "halflife2",
		size = 20,
		weight = 0,
		antialias = false,
	...
	surface.CreateFont( "dhfont_txt3", {
		font = "DIN Light",
		size = 36,
		weight = 0,
		antialias = false,
	...
	surface.CreateFont( "dhfont_txt2", {
		font = "DIN Medium",
		size = 24,
		weight = 2,
		antialias = false,
	...
	surface.CreateFont( "dhfont_txt1", {
		font = "DIN Light",
		size = 24,
		weight = 2,
		antialias = false,
	...
	surface.CreateFont( "dhfont_txt0", {
		font = "DIN Medium",
		size = 16,
		weight = 400,
		antialias = false,
	...
	surface.CreateFont( "dhfont_num3_nob", {
		font = "halflife2",
		size = 36,
		weight = 0,
		antialias = false,
	...
	surface.CreateFont( "dhfont_num2_nob", {
		font = "halflife2",
		size = 26,
		weight = 2,
		antialias = false,
	...
	surface.CreateFont( "dhfont_num1_nob", {
		font = "halflife2",
		size = 26,
		weight = 2,
		antialias = false,
	...
	surface.CreateFont( "dhfont_num0_nob", {
		font = "halflife2",
		size = 20,
		weight = 0,
		antialias = false,
	...
	surface.CreateFont( "dhfont_txt3_nob", {
		font = "DIN Light",
		size = 36,
		weight = 0,
		antialias = false,
	...
	surface.CreateFont( "dhfont_txt2_nob", {
		font = "DIN Medium",
		size = 24,
		weight = 2,
		antialias = false,
	...
	surface.CreateFont( "dhfont_txt1_nob", {
		font = "DIN Light",
		size = 24,
		weight = 2,
		antialias = false,
	...
	surface.CreateFont( "dhfont_txt0_nob", {
		font = "DIN Medium",
		size = 16,
		weight = 400,
		antialias = false,
